...
public class VdmaChannelReaderThreadOrg extends Thread {
	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(VdmaChannelReaderThreadOrg.class);
	...
	public VdmaChannelReaderThreadOrg(VdmaMessageProcessor processor) {
