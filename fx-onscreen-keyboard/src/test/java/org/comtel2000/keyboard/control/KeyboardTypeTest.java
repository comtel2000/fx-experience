...
public class KeyboardTypeTest extends ApplicationTest {
  ...
  public void testKeyboardTypeNumeric() throws InterruptedException {
    ...
    IntStream.rangeClosed('a', 'z').forEach(i -> verifyThat(Character.toString((char)i), isNull()));
    IntStream.rangeClosed('0', '9').forEach(i -> verifyThat(Character.toString((char)i), isNotNull()));
